...
from .models import Department, Location, Vendor, Category, Asset, AssetSpecification, AssetIPAddress, NetworkInterface, Infrastructure, AssetLoan, Software, SoftwareAllocation, CloudAsset, Contract
...
class AssetAdmin(ImportExportModelAdmin):
    ...
    inlines = [AssetSpecificationInline, NetworkInterfaceInline, SoftwareAllocationInline]
