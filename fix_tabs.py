...
nav_target = '''                <li class="nav-item">
                    <a class="nav-link fw-bold" data-bs-toggle="tab" href="#notes" role="tab">Notes</a>
                </li>'''
...
content = content.replace('<div class="tab-pane fade" id="notes" role="tabpanel">', doc_html + '\n                <div class="tab-pane fade" id="notes" role="tabpanel">')

with open('assets/templates/assets/asset_detail.html', 'w', encoding='utf-8') as f:
    f.write(content)
print("Asset Detail Tabs Fixed.")
